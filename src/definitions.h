...
static constexpr auto STATUS_SERVER_NAME = "OTP Premium Server";
static constexpr auto STATUS_SERVER_VERSION = "Based on TFS 1.3";
static constexpr auto STATUS_SERVER_CREDITS = "OTP Team and Contributors, OTXServer and The Forgotten Server Developers";
